...
export default class TimelinePlugin {
    constructor(params, ws) {
        ...
        this.timelineClick = this.params.timelineClickFunction;
     ...
     */
    static create(params, ws) {

        return new TimelinePlugin(params, ws);
    }
    ...
    createWrapper() {
        ...
        this._onClick = e => {
            ...
            this.timelineClick((relX / this.wrapper.scrollWidth) || 0);
    ...
    drawTimeCanvases() {
        ...
        const wsParams = this.wavesurfer.params;
        const duration = this.wavesurfer.getMaxTrackLength();
        ...
        const incBias = 20;
        const height1 = this.params.height - 4 + incBias;
        const height2 = (this.params.height * (this.params.notchPercentHeight / 100)) - 4 + incBias;
        ;
