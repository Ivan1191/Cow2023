...
export default class WaveSurfer extends util.Observer {
    ...
    constructor(params) {
        ...
        */
        ...
        this.getMaxTrackLength = this.params.getMaxTrackLengthFunction;
        this.setMaxTrackLength = this.params.setMaxTrackLengthFunction;
        this.synchronizeProgress = this.params.synchronizeProgressFunction;
        return this;
    }
    ...
    drawBuffer() {
        ...
        let maxTrackLength = this.getMaxTrackLength();
        // Fill container
    ...
    adjustProgress(progress) {
        var time = progress * this.getMaxTrackLength();
